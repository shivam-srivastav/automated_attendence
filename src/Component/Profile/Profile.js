    ...
    render() { 
        return ( <div className="profile">
            <div className="profile-title">
                <h1> <span><FaUserAlt/></span> Shivam Srivastava</h1>
                <h4><a href="./">Sign out</a></h4>
            </div>
            ...
            <div className="profile-main-left">
               ...
               <div className="profile-main-left-line">

               </div>
            </div>
            <div className="profile-main-right">
                <div className="profile-main-right-horizontal">
                    <div onClick={this.onClickView}><h4>View</h4></div>
                    <div onClick={this.onClickInsert}><h4>Insert</h4></div>
                    <div><h4>Create/Update Class</h4></div>
                </div>
